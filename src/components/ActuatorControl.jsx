...
import { CircleDot, Lightbulb, Bell } from 'lucide-react';

const ActuatorControl = ({ sensorData }) => {
  return (
    <div className="bg-gray-800/50 backdrop-blur-sm rounded-xl p-6 border border-gray-700">
      <h3 className="text-lg font-semibold text-white mb-4">Actuator Status</h3>
